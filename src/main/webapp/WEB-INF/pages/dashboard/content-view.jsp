...
<script src="/js/dashboard/const.js?v=3" charset=“UTF-8”></script>

<script src="/js/dashboard/pager/pager.js?v=3" charset=“UTF-8”></script>
<script src="/js/dashboard/jumper/allets-data-jumper.js?v=3" charset=“UTF-8”></script>

<script src="/js/dashboard/content/content-view.js?v=3" charset=“UTF-8”></script>
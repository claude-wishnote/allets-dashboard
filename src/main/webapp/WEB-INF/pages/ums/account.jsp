                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row" style="margin-left: 0px;margin-right: 0px">
                            ...
                            <div class="col-sm-3 text-right">
                                <a id="userInfoOutfButton" class="btn btn-default"><span
                                        class="glyphicon fa fa-user-times"></span><span data-i18n="ums.account.management.outf"></span></a>
                                <a id="userInfoUnOutfButton" style="display:none"
                                   class="btn btn-info"><span
                                        class="glyphicon fa fa-user-times"></span><span
                                        data-i18n="ums.account.management.unoutf"></span></a>
                                <a id="userInfoOutButton" class="btn btn-default"><span
                                        class="glyphicon fa fa-user-times"></span><span
                                        data-i18n="ums.account.management.out"></span></a>
                                <a id="userInfoUnOutButton" style="display:none"
                                   class="btn btn-info"><span
                                        class="glyphicon fa fa-user-times"></span><span
                                        data-i18n="ums.account.management.unout"></span></a>
                            </div>
                        </div>
                        ...
                        <div class="row searchhelpbar mg-grid">
                            ...
                            <div class="col-sm-7 text-right">
                                <a id="resetUserInfoPopoverButton" class="btn btn-default" rel="popover">
                                    <span class="glyphicon glyphicon-edit"></span><span
                                        data-i18n="ums.account.management.info.reset"></span>
                                </a>
                                <a id="editUserInfoPopoverButton" class="btn btn-default" rel="popover">
                                    <span class="glyphicon glyphicon-edit"></span><span
                                        data-i18n="ums.account.management.info.edit"></span>
                                </a>
                                <a id="userInfoBlackListButton" class="btn btn-default">
                                    <span class="glyphicon fa fa-user-secret"></span><span
                                        data-i18n="ums.account.management.blacklist.register"></span>
                                </a>
                            </div>
                            <!-- /button area -->
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="widget">
                            <div class="widget-body">
                                ...
                                <table class="table table-bordered mgt10 text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a id="userInfoSendAlertA1" class="btn btn-blue btn-sm" rel="popover" data-i18n="ums.account.management.sendAlert">
                                                Send to Alert
                                            </a>
                                        </td>
                                        <th class="bg">
                                        ...
                                        <td>
                                            ...
                                            <br/>
                                            <a id="userInfoSendAlertA2" class="btn btn-blue btn-sm" rel="popover" data-i18n="ums.account.management.sendAlert">
                                                Send to Alert
                                            </a>
                                        </td>
                                ...
                                <!-- data table -->
                                <br/>
                                <table id="userInfoReportedCommentTable"
...
<div class="modal fade bs-example-modal-sm pw-layer in" id="handleUserModel">
    <div class="modal-dialog">
        <div class="modal-content" style="border: solid;border-color: #cd2929">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
            ...
            <div class="modal-body">
                <p id="handleUserSting">You want to handle account:</p>
            </div>
            <div class="modal-footer">
                <input type="hidden" id="handleUrl"/>
                <button type="button" class="btn btn-default" data-dismiss="modal" id="handleCancel">cancel</button>
                <a class="btn btn-danger" data-dismiss="modal" id="handleOK">ok</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<script src="/js/umsjs/account/accountInfo.js" charset=“UTF-8”></script>

        ...
        <div class="page-content">
                ...
                <div class="header-title">
                    <h1>
                        ...
                        <small>
                            ...
                            <span data-i18n="ums.report.comment"></span>
                        </small>
                    </h1>
                </div>
            </div>
            ...
            <div class="page-body" style="overflow:auto">
                ...
                <div class="row searchbar">
                    <div class="col-sm-12">
                        <select style="width: 7%;" id="reportedCommentLimit">
                            <option value="30">30</option>
                            <option value="50" selected="selected">50</option>
                            <option value="100">100</option>
                        </select>
                        <select style="width: 13%;" id="reportedCommentSearchField">
                        ...
                        <select style="width: 16%;" id="searchSource">
                        ...
                        <i style="width: 5%;height: 85%" class="btn glyphicon glyphicon-refresh blue" id="refreshButton"></i>
                        <br>
                        <span class="input-icon" style="width:55%;" >
                            <input style="display: none;height: 30px;"  type="text" id="userSearchKeyword" class="form-control input-smdrop down-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <input type="text" class="form-control input-sm" id="reportedCommentSearchKeyword">
                            <i class="btn btn-sm glyphicon glyphicon-search blue" id="reportedCommentSearchButton"></i>
                        </span>
                        <button style="width: 7%;"  href="javascript:void(0);" id="initSearchButton" class="btn btn-info btn-sm" data-i18n="ums.handle.history.comment.reset"></button>
                    </div>
                </div>
                <!-- /search bar-->
                <!-- calendar-->
                        ...
                        <div class="calendar-section">
                            <div class="calendar-box">
                                <div class="input-group">
                                    <input class="form-control date-picker" id="reportedCommentStartDatePicker" type="text"
                                           value="">
                                    <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </span>
                                </div>
                                <span class="icon-sub-txt" data-i18n="ums.handle.history.comment.from" style="width:190px;"></span>
                            </div>
                            <div class="calendar-box" style="margin-right: 40px">
                                <div class="input-group">
                                    <input class="form-control date-picker" id="reportedCommentEndDatePicker" type="text"
                                           value="">
                                    <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </span>
                                </div>
                                <span class="icon-sub-txt" data-i18n="ums.handle.history.comment.to" style="width:180px;"></span>
                            </div>
                        </div>
                        <div class="calendar-btn" style="display: none">
                            <button href="javascript:void(0);" id="searchButton" class="btn btn-info btn-sm" data-i18n="ums.handle.history.search"></button>
                            <%--<button href="javascript:void(0);" id="initSearchButton" class="btn btn-info btn-sm">초기화--%>
                            </button>
                            <select id="reportedCommentPeriodDays">
                                <option id="reportedCommentPeriodDays1" value="1" data-i18n="ums.handle.history.comment..1day">1일</option>
                                <option id="reportedCommentPeriodDays7" value="7" data-i18n="ums.handle.history.comment..7day">7일</option>
                                <option id="reportedCommentPeriodDays30" value="30" data-i18n="ums.handle.history.comment..1month">1개월</option>
                            </select>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="widget-body">
                                ...
                                <table id="reportedCommentTable"
                                    ...
                                    <tr>
                                        <th>
                                            <label>
                                                <input type="checkbox" id="totalChecked">
...
<script src="/js/umsjs/comment/reportedComment.js" charset=“UTF-8”></script>
